...
func (x *SumRequest) GetFirst() float32 {
	if x != nil {
		return x.First
	}
	return 0
...
func (x *SumRequest) GetSecond() float32 {
	if x != nil {
		return x.Second
	}
	return 0
...
var file_greet_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x3a, 0x0a, 0x0a,
	...
	0x42, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	...
	0x6e, 0x73, 0x65, 0x32, 0x3b, 0x0a, 0x0b, 0x43, 0x61, 0x6c, 0x63, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x2c, 0x0a, 0x03, 0x53, 0x75, 0x6d, 0x12, 0x11, 0x2e, 0x67, 0x72, 0x65, 0x65,
	...
	0x72, 0x7a, 0x65, 0x67, 0x61, 0x62, 0x2f, 0x67, 0x52, 0x50, 0x43, 0x2f, 0x67, 0x72, 0x65, 0x65,
...
var file_greet_proto_depIdxs = []int32{
	...
	2, // 1: greet.CalcService.Sum:input_type -> greet.SumRequest
	1, // 2: greet.GreetService.Greet:output_type -> greet.GreetResponse
	3, // 3: greet.CalcService.Sum:output_type -> greet.SumResponse
